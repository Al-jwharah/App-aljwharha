...
export default async function TrademarksPage() {
    const { data: listings, total } = await getListings('TRADEMARK');

    return (
        <>
            <section className="page-hero">
                <h1>🏷️ علامات تجارية</h1>
                <p>تصفح العلامات التجارية المتاحة للبيع والتملك</p>
            </section>
            ...
            <section className="section">
                ...
                {listings.length === 0 ? (
                    <div style={{ textAlign: 'center', padding: '64px 0', color: 'var(--color-muted)' }}>
                        ...
                        <p style={{ fontSize: '0.85rem' }}>كن أول من يضيف علامة تجارية!</p>
                    </div>
                ) : (
                        ...
                        {listings.map((l: Listing) => (
                            <div key={l.id} className="card">
                                ...
                                <div className="card-body">
                                    <span className="card-type trademark">علامة تجارية</span>
