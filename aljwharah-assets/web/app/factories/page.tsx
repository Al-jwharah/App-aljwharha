...
export default async function FactoriesPage() {
    const { data: listings, total } = await getListings('FACTORY');

    return (
        <>
            <section className="page-hero">
                <h1>🏭 مصانع</h1>
                <p>تصفح المصانع المتاحة للبيع والاستثمار</p>
            </section>
            ...
            <section className="section">
                ...
                {listings.length === 0 ? (
                    <div style={{ textAlign: 'center', padding: '64px 0', color: 'var(--color-muted)' }}>
                        ...
                        <p>لا توجد مصانع حالياً</p>
                        <p style={{ fontSize: '0.85rem' }}>كن أول من يضيف مصنعاً!</p>
                    </div>
                ) : (
                        ...
                        {listings.map((l: Listing) => (
                            <div key={l.id} className="card">
                                ...
                                <div className="card-body">
                                    <span className="card-type factory">مصنع</span>
